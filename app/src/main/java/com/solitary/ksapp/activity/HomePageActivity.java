...
import com.solitary.ksapp.fragment.ExitDialogFragment;
...
import static com.solitary.ksapp.utils.Constants.TermsAndCondition.INTENT_TIPS_LIST_KEY;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    ...
                    case R.id.google_privacy:
                        ...
                        break;
//                    case R.id.set_pin:
//                        startActivity(new Intent(HomePageActivity.this,PinLockActivity.class));
//                        break;
                    default:
                        return true;
                }
